...
def getUrl():
    url = 'http://www.cnpereading.com/index/advancedSearchSubmit?taxonomy=R%20%E5%8C%BB%E8%8D%AF%E3%80%81%E5%8D%AB%E7%94%9F'
    detail_urls = []
    for i in range(96292):
        soup = get(url, i)
        ...
        for detail in details:
            ...
            writeurl2txt('data/易阅通_UrlR.txt',detail_url)
            print(detail_url)
